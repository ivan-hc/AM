...
version=$(echo "https://broth.itch.zone$(curl -Ls https://broth.itch.zone/install-itch/linux-appimage-amd64 | tr '">< ' '\n' | grep "archive.zip" | head -1)" | sed 's/&#43;/+/g')
wget "$version" || exit 1
