...
am hide "$app_name1"
am -f > "$test_results"
_check_count "$app_name1.*MiB" 0 "$test_results"

# Test hide for another app
_log "Test hide $app_name2..."
am hide "$app_name2"
am -f > "$test_results"
_check_count "$app_name2.*MiB" 0 "$test_results"

# Test unhide
_log "Test unhide $app_name1..."
am unhide "$app_name1"
am -f > "$test_results"
_check_count "$app_name1.*MiB" 1 "$test_results"

# Test hide for another app
_log "Test unhide $app_name2..."
am unhide "$app_name2"
am -f > "$test_results"
_check_count "$app_name2.*MiB" 1 "$test_results"
